...
def run_biclique_partition_on_formula(formula_filename, forced_r: Optional[int] = None, delta_r = 0, output_formula_filename="tmp/result_bp.cnf"):
    ...
    resulting_formula.serialize(output_formula_filename)
